...
docker build \
  ...
  -t inputoutput/cardano-rosetta:2.0.0-rc.2 \
  https://github.com/input-output-hk/cardano-rosetta.git#2.0.0-rc.2
```
...
docker build \
  ...
  --cache-from=inputoutput/cardano-rosetta:master \
  -t inputoutput/cardano-rosetta:2.0.0-rc.2-preprod \
  https://github.com/input-output-hk/cardano-rosetta.git#2.0.0-rc.2
```
...
docker build \
  ...
  --cache-from=inputoutput/cardano-rosetta:master \
  -t inputoutput/cardano-rosetta:2.0.0-rc.2-preview \
  https://github.com/input-output-hk/cardano-rosetta.git#2.0.0-rc.2
```
...
docker run \
  ...
  --shm-size=2g \
  inputoutput/cardano-rosetta:2.0.0-rc.2
```
...
docker run \
  ...
  --shm-size=2g \
  inputoutput/cardano-rosetta:2.0.0-rc.2-preprod
```
...
docker run \
  ...
  --shm-size=2g \
  inputoutput/cardano-rosetta:2.0.0-rc.2-preview
```
...
docker build \
  ...
  --cache-from=inputoutput/cardano-rosetta:master \
  -t inputoutput/cardano-rosetta:2.0.0-rc.2-apply-snapshot \
  https://github.com/input-output-hk/cardano-rosetta.git#2.0.0-rc.2
```
...
docker run \
  ...
  -v cardano-rosetta:/data \
  --shm-size=2g \
  inputoutput/cardano-rosetta:2.0.0-rc.2-apply-snapshot
```
