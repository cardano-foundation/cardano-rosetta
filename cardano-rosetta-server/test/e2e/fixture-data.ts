...
export const CONSTRUCTION_SIGNED_TRANSACTION_WITH_MA = cbor
  .encode([SIGNED_TX_WITH_MA, constructionExtraData(CONSTRUCTION_PAYLOADS_REQUEST_WITH_MA)], undefined)
  .toString('hex');

export const CONSTRUCTION_SIGNED_TRANSACTION_WITH_MULTIPLE_MA = cbor
  .encode([
    SIGNED_TX_WITH_MULTIPLE_MA,
    constructionExtraData(CONSTRUCTION_PAYLOADS_REQUEST_WITH_MULTIPLE_MA),
    undefined
  ])
  .toString('hex');
...
export const CONSTRUCTION_SIGNED_TX_WITH_MA_WITHOUT_NAME = cbor
  .encode([
    ...
    constructionExtraData(CONSTRUCTION_PAYLOADS_REQUEST_WITM_MA_WITHOUT_NAME),
    undefined
  ])
  .toString('hex');

export const CONSTRUCTION_SIGNED_TRANSACTION_WITH_SEVERAL_MA = cbor
  .encode([SIGNED_TEX_WITH_SEVERAL_MA, constructionExtraData(CONSTRUCTION_PAYLOADS_REQUEST_WITH_SEVERAL_MA), undefined])
  .toString('hex');

export const CONSTRUCTION_SIGNED_TRANSACTION_WITH_EXTRA_DATA = cbor
  .encode([SIGNED_TRANSACTION, constructionExtraData(CONSTRUCTION_PAYLOADS_REQUEST), undefined])
  .toString('hex');

export const CONSTRUCTION_SIGNED_TRANSACTION_WITH_EXTRA_DATA_INVALID_TTL = cbor
  .encode([SIGNED_TRANSACTION, constructionExtraData(CONSTRUCTION_PAYLOADS_REQUEST_INVALID_TTL), undefined])
  .toString('hex');
...
export const CONSTRUCTION_SIGNED_TX_WITH_BYRON_ADDRESS_AND_EXTRA_DATA = cbor
  .encode([
    ...
    constructionExtraData(CONSTRUCTION_PAYLOADS_REQUEST_WITH_BYRON_OUTPUT),
    undefined
  ])
  .toString('hex');
...
export const CONSTRUCTION_INVALID_TRANSACTION = cbor
  .encode(['invalid_tx', constructionExtraData(CONSTRUCTION_PAYLOADS_REQUEST), undefined])
  .toString('hex');
