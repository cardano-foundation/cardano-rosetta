...
const allow = {
  ...
  errors: [
    ...
    { code: 4002, message: 'Network not found', retriable: false },
    { code: 4003, message: 'Networks not found', retriable: false },
    { code: 4004, message: 'Invalid blockchain', retriable: false },
    { code: 4005, message: 'Genesis block not found', retriable: false },
    { code: 4006, message: 'Transaction not found', retriable: false },
    ...
    { code: 4013, message: 'Cant deserialize transaction input from transaction body', retriable: false },
    { code: 4014, message: 'Cant deserialize transaction output from transaction body', retriable: false },
    { code: 4015, message: 'Provided address is invalid', retriable: true },
    { code: 4016, message: 'Provided address type is invalid', retriable: true },
    ...
    { code: 4019, message: 'Provided operation type is invalid', retriable: true },
    { code: 4020, message: 'Pool key hash is required to operate', retriable: false },
    { code: 4021, message: 'Assets are required for output operation token bundle', retriable: false },
    { code: 4022, message: 'Asset value is required for token asset', retriable: false },
    { code: 4023, message: 'Invalid policy id', retriable: false },
    { code: 4024, message: 'Invalid token name', retriable: false },
    { code: 4025, message: 'Provided pool key hash has invalid format', retriable: false },
    { code: 4026, message: 'Pool registration certificate is required for pool registration', retriable: false },
    { code: 4027, message: 'Invalid pool registration certificate format', retriable: false },
    { code: 4028, message: 'Invalid certificate type. Expected pool registration certificate', retriable: false },
    { code: 4029, message: 'Pool registration parameters were expected', retriable: false },
    ...
    { code: 4033, message: 'Invalid pool relay type received', retriable: false },
    { code: 4034, message: 'Invalid pool owners received', retriable: false },
    { code: 4035, message: 'Invalid pool registration parameters received', retriable: false },
    { code: 4036, message: 'Mandatory parameter is missing: Epoch', retriable: false },
    { code: 4037, message: 'Error when sending the transaction - OutsideValidityIntervalUTxO', retriable: false },
    { code: 5000, message: 'An error occurred', retriable: true },
    { code: 5001, message: 'Not implemented', retriable: false },
    ...
    { code: 5006, message: 'Error when sending the transaction', retriable: true },
    { code: 5007, message: 'Voting nonce not valid', retriable: false },
